/**
 * @ngdoc controller
 * @name cloudfastApp.admin.user.list.detail.controller:UserDetailController
 * @description
...
(function () {
	 ...
	 */
	angular
		.module('cloudfastApp.admin.user.list.detail')
		.controller('UserDetailController', UserDetailController);

	/**
	 * @ngdoc function
	 * @name cloudfastApp.admin.user.list.detail.provider:UserDetailController
	 * @description
	 * Provider of the {@link cloudfastApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
	 *
	 ...
	 * @returns {Service} {@link cloudfastApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
	 */
	...
	function UserDetailController($state, user, Auth) {
		 ...
		 * @ngdoc property
		 * @name user
		 * @propertyOf cloudfastApp.admin.user.list.detail.controller:UserDetailController
		 * @description
		 ...
		 * @ngdoc function
		 * @name edit
		 * @methodOf cloudfastApp.admin.user.list.detail.controller:UserDetailController
		 * @description
