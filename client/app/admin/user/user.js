(function () {
	...
	/**
	 * Introduce the cloudfastApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {cloudfastApp.admin.user.list}
	 * @requires {cloudfastApp.admin.user.create}
	 */
	angular
		.module('cloudfastApp.admin.user', [
			'ngResource',
			'ui.router',
			'cloudfastApp.admin.user.list',
			'cloudfastApp.admin.user.create'
		])
