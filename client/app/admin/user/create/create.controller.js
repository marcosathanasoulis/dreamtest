/**
 * @ngdoc controller
 * @name cloudfastApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
	...
	angular
		.module('cloudfastApp.admin.user.create')
		.controller('UserCreateController', UserCreateController);

	/**
	 * @ngdoc function
	 * @name cloudfastApp.admin.user.create.provider:UserCreateController
	 * @description
	 * Provider of the {@link cloudfastApp.admin.user.create.controller:UserCreateController UserCreateController}
	 *
	 ...
	 * @returns {Service} {@link cloudfastApp.admin.user.create.controller:UserCreateController UserCreateController}
	 */
	...
	function UserCreateController($mdDialog, Auth, User, Toast) {
		 ...
		 * @ngdoc property
		 * @name userRoles
		 * @propertyOf cloudfastApp.admin.user.create.controller:UserCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name create
		 * @methodOf cloudfastApp.admin.user.create.controller:UserCreateController
		 * @description
