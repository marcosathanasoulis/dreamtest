/**
 * @ngdoc controller
 * @name cloudfastApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
	...
	angular
		.module('cloudfastApp.admin.user.list.edit')
		.controller('EditPasswordController', EditPasswordController);


	/**
	 * @ngdoc function
	 * @name cloudfastApp.admin.user.list.edit.provider:EditPasswordController
	 * @description
	 * Provider of the {@link cloudfastApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 *
	 ...
	 * @returns {Service} {@link cloudfastApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 */
	...
	function EditPasswordController($mdDialog, UserService, user, Toast) {
		 ...
		 * @ngdoc function
		 * @name changePassword
		 * @methodOf cloudfastApp.admin.user.list.edit.controller:EditPasswordController
		 * @description
