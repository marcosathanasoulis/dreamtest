/**
 * @ngdoc overview
 * @name cloudfastApp.admin.user.create
 * @description
 * The `cloudfastApp.admin.user.create` module which provides
 *
 * - {@link cloudfastApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
