/**
 * @ngdoc overview
 * @name cloudfastApp.admin.user.list.detail
 * @description
 * The `cloudfastApp.admin.user.list.detail` module which provides:
 *
 * - {@link cloudfastApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires cloudfastApp.auth.user
 */
(function () {
	'use strict';
