/**
 * @ngdoc controller
 * @name cloudfastApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name cloudfastApp.admin.user.list.items.provider:UserItemsController
	 * @description
	 * Provider of the {@link cloudfastApp.admin.user.list.items.controller:UserItemsController UserItemsController}
	 *
	 */
	...
	function UserItemsController($state, Auth) {
		 ...
		 * @ngdoc function
		 * @name isSelected
		 * @methodOf cloudfastApp.admin.user.list.items.controller:UserItemsController
		 * @description
