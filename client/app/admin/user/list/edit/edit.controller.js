/**
 * @ngdoc controller
 * @name cloudfastApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name cloudfastApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link cloudfastApp.admin.user.list.edit.controller:UserEditController UserEditController}
